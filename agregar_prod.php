...
if (isset($_FILES['images'])) {
    ...
    // Check connection
                ...
                $sql = "INSERT INTO catalogo SET nombre_p='$nombre_p' , cantidad='$cantidad_p' , precio='$precio_n' , precio_m='$precio_m' , foto='$destino'";
    
                if ($conn->query($sql) === true) {
                    echo '<script language="javascript">alert("Foto actualizada con exito");</script>';
                    echo "<script>window.location='admin/agregar_p.php';</script>";
                } else {
