    ...
    <section>
        <div class="container">
                    ...
                    <div class="col-md-12">
                        ...
                        <table id="myTable" class="table table-striped" style="background-color: whitesmoke;">
                            ...
                            <tr style="background-color: pink;">
                                ...
                                <td style="text-align: center;">Total:$<?php echo $totalG ?></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td style="text-align: center;"></td>
                                <td style="text-align: center;"></td>
                                <td style="text-align: center;">Total con Envío</td>
                                <td style="text-align: center;">$<?php echo $total_total=$totalG+$envio ?></td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-12">
                    <a href="modificar_n.php?clave_n=<?php echo $clave_de_nota ?>"><button class="btn btn-success" style="float: right; color: white;">Modificar Nota</button></a>
                </div><br><br><br>
