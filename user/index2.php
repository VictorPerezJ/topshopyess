            ...
            <div class="row justify-content">
                ...
                <div class="col-md-4">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">Precio: $<?php echo por_agotarse($precio) ?></div>
                        <div class="card-body">Precio Menudeo: $<?php echo $precio_m ?></div>
                        <!-- <a href="carrito.php?id=<?php echo $id_p ?>"><button class='btn btn-primary' style="width:100%"> <i class="fas fa-cart-plus"></i> Agregar</button></a> -->
                    </div>
                </div>
                <?php
                }
